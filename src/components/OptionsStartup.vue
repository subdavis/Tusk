<template>
  <div>
  	<h3>Getting Started with CKPX</h3>
		...
		<p>That's it! CKPX will automatically discover any Keepass databases that your have in your cloud storage, and allow you to switch between databases from the browser popup.</p>
